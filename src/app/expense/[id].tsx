        ...
        >
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 14 }}>
            ...
            <Pressable
              ...
              style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: '#EF444415', alignItems: 'center', justifyContent: 'center' }}
            >
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }} keyboardShouldPersistTaps="handled">
            <Text style={{ color: colors.secondary, fontSize: 13, textAlign: 'center', marginTop: 4 }}>
              Added on {formatDate(expense.date)}
            </Text>
            
            {/* Amount Hero Input */}
            <Animated.View entering={FadeInDown.delay(50).duration(400)} style={{ alignItems: 'center', paddingVertical: 24, paddingHorizontal: 20 }}>
